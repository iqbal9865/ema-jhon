    ...
    return (
        <div className="d-flex product-container row">
            ...
            <div className="col-sm-12 col-md-8">
                ...
                <button onClick={() => props.handleAddToCart(props.product)} className=" rounded mx-4 mb-4 buy-now-btn">ADD TO CART  <FontAwesomeIcon style={{color:'black', fontSize:"15px", marginLeft:' 3px'}} icon={faCartPlus} /></button>
            </div>
